...
internal class UserEntryCategoryRepository(DatabaseContext databaseContext, ILogger<UserEntryCategoryRepository> logger)
 : IGetUserUserEntryCategories,
  IStoreUserEntryCategory,
  IUpdateUserEntryCategory,
  IDeleteUserEntryCategory
{
  async Task<Core.UserEntryCategories.UserEntryCategoryEntity[]> IGetUserUserEntryCategories.Execute(int userId, CancellationToken cancellationToken)
  {
    ...
    CancellationToken cancellationToken)
  {
    try
    {
      ...
      return ValueOrErrorResult<Core.UserEntryCategories.UserEntryCategoryEntity, StoreUserEntryCategoryError>.CreateSuccess(new Core.UserEntryCategories.UserEntryCategoryEntity(
        id: entity.Id,
        name: entity.Name,
    ...
    {
      return ValueOrErrorResult<Core.UserEntryCategories.UserEntryCategoryEntity, StoreUserEntryCategoryError>.CreateFailure(StoreUserEntryCategoryError.DuplicateName);
    }
    catch (Exception ex)
    {
      logger.LogError(ex, "Unexpected error whilst storing new entry category");
      return ValueOrErrorResult<Core.UserEntryCategories.UserEntryCategoryEntity, StoreUserEntryCategoryError>.CreateFailure(StoreUserEntryCategoryError.Unknown);
    }
  }
    ...
    CancellationToken cancellationToken)
  {
    try
    {
      var entity = databaseContext.UserEntryCategories.SingleOrDefault(ec => ec.Id == userEntryCategoryId);
      if (entity == null)
      {
        return MaybeErrorResult<UpdateUserEntryCategoryError>.CreateFailure(UpdateUserEntryCategoryError.UserEntryCategoryDoesNotExist);
      }
      if (entity.UserId != userId)
      {
        return MaybeErrorResult<UpdateUserEntryCategoryError>.CreateFailure(UpdateUserEntryCategoryError.UserEntryCategoryBelongsToOtherUser);
      }
    ...
    {
      return MaybeErrorResult<UpdateUserEntryCategoryError>.CreateFailure(UpdateUserEntryCategoryError.DuplicateName);
    }
    catch (Exception ex)
    {
      logger.LogError(ex, "Unexpected error whilst updating existing entry category");
      return MaybeErrorResult<UpdateUserEntryCategoryError>.CreateFailure(UpdateUserEntryCategoryError.Unknown);
    }
  }
    ...
    CancellationToken cancellationToken)
  {
    try
    {
      ...
      if (entity == null)
      {
        return MaybeErrorResult<DeleteUserEntryCategoryError>.CreateFailure(DeleteUserEntryCategoryError.UserEntryCategoryDoesNotExist);
      }
      if (entity.UserId != userId)
      {
        return MaybeErrorResult<DeleteUserEntryCategoryError>.CreateFailure(DeleteUserEntryCategoryError.UserEntryCategoryBelongsToOtherUser);
      }
    ...
    catch (Exception ex)
    {
      ...
      return MaybeErrorResult<DeleteUserEntryCategoryError>.CreateFailure(DeleteUserEntryCategoryError.Unknown);
    }
  }
}