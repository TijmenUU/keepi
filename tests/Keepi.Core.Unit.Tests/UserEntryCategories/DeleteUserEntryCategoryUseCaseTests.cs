...
public class DeleteUserEntryCategoryUseCaseTests
{
  ...
  public async Task Execute_deletes_existing_entry_category()
  {
    var context = new TestContext()
      .WithSuccesfulUserEntryCategoryDeletion();
    ...
    context.DeleteUserEntryCategoryMock.Verify(x => x.Execute(
      42,
      981,
  ...
  {
    var context = new TestContext()
      .WithFailedUserEntryCategoryDeletion(DeleteUserEntryCategoryError.UserEntryCategoryDoesNotExist);
  ...
  {
    var context = new TestContext()
      .WithFailedUserEntryCategoryDeletion(DeleteUserEntryCategoryError.UserEntryCategoryBelongsToOtherUser);
  ...
  {
    var context = new TestContext()
      .WithFailedUserEntryCategoryDeletion(DeleteUserEntryCategoryError.Unknown);
  ...
  class TestContext
  {
    public Mock<IDeleteUserEntryCategory> DeleteUserEntryCategoryMock { get; } = new(MockBehavior.Strict);
